 ...
 * @return {string}
 */
Package.prototype.getResolveUrl = function () {
    return this.repos.resolvedUrl;
};
...
Package.prototype.initResolvedInfo = function (info) {
    ...
    if (info.endpoint) {
        ...
        option.endPoint.type = info.endpoint;
    }

    this.initRepository(option.endPoint, info.resolved);
    this.installVersion = info.version;
};
