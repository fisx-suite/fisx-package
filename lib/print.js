...
exports.listPackages = function (info, options) {
    ...
    switch (options.style) {
        case 'list':
            ...
            listPackageByList(projectPkg, options, listMap);

            var statInfo = [
                'Total package number: ' + String(Object.keys(listMap).length - 2).green
            ];
