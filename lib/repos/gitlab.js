...
function GitlabRepos(options) {
    ...
    var domain = options.reposDomain || config.defaultGitlabDomain;
 ...
 * @return {string}
 */
GitlabRepos.prototype.getHostName = function () {
    return this.reposDomain.replace(/^http(s)?:\/\/|\/+$/g, '');
};
 ...
 * @return {Object}
 */
GitlabRepos.prototype.getInstallSource = function () {
    var path = 'git://' + this.getHostName()
        + '/' + this.owner + '/'
        + this.pkgName + '.git';
 ...
 * @return {string}
 */
GitlabRepos.prototype.getReposUrl = function () {
